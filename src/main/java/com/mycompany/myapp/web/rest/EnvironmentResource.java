...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Environment}.
 */
@RestController
@RequestMapping("/api")
public class EnvironmentResource {
    ...
    public ResponseEntity<EnvironmentDTO> updateEnvironment(@RequestBody EnvironmentDTO environmentDTO) throws URISyntaxException {
