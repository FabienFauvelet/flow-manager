...
public class Environment implements Serializable {
    ...
    @OneToMany(mappedBy = "componentDetails")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<ComponentDetails> componentDetails = new HashSet<>();

    @OneToMany(mappedBy = "environment")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<ComponentDetails> environments = new HashSet<>();
    ...
    public Set<ComponentDetails> getEnvironments() {
        return environments;
    }

    public Environment environments(Set<ComponentDetails> componentDetails) {
        this.environments = componentDetails;
        return this;
    }

    public Environment addEnvironment(ComponentDetails componentDetails) {
        this.environments.add(componentDetails);
        componentDetails.setEnvironment(this);
        return this;
    }

    public Environment removeEnvironment(ComponentDetails componentDetails) {
        this.environments.remove(componentDetails);
        componentDetails.setEnvironment(null);
        return this;
    }

    public void setEnvironments(Set<ComponentDetails> componentDetails) {
        this.environments = componentDetails;
    }
