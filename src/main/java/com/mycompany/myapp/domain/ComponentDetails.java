...
public class ComponentDetails implements Serializable {
    ...
    private ArchitectureComponent detailsByEnvironement;

    @ManyToOne
    @JsonIgnoreProperties(value = "componentDetails", allowSetters = true)
    private Environment componentDetails;
    ...
    public ArchitectureComponent getDetailsByEnvironement() {
        return detailsByEnvironement;
    }

    public ComponentDetails detailsByEnvironement(ArchitectureComponent architectureComponent) {
        this.detailsByEnvironement = architectureComponent;
        return this;
    }

    public void setDetailsByEnvironement(ArchitectureComponent architectureComponent) {
        this.detailsByEnvironement = architectureComponent;
    }

    public Environment getComponentDetails() {
        return componentDetails;
    }

    public ComponentDetails componentDetails(Environment environment) {
        this.componentDetails = environment;
        return this;
    }

    public void setComponentDetails(Environment environment) {
        this.componentDetails = environment;
    }
