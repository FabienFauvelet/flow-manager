...
export class FlowUpdateComponent implements OnInit {
  ...
  updateForm(flow: IFlow): void {
    this.editForm.patchValue({
      ...
      status: flow.status,
      componentFromId: flow.componentFromId,
      componentToId: flow.componentToId,
  ...
  private createFromForm(): IFlow {
    return {
      ...
      componentFromId: this.editForm.get(['componentFromId'])!.value,
      componentToId: this.editForm.get(['componentToId'])!.value,
